                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (empty($d->foto))
                                                <img src="{{ asset('assets/img/nophoto.webp') }}" class="avatar" alt="">
                                                @else
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="nik" class="form-control" name="nik" placeholder="Nomor Induk Karyawan">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="no_hp" class="form-control" name="no_hp" placeholder="Nomor Telepon">
                            </div>
                        </div>
                    </div>
                    <div class="row">
