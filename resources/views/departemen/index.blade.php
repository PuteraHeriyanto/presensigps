                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" name="nama_dept" id="nama_dept" class="form-control" placeholder="Nama Departement" value="{{ Request('nama_dept') }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="kode_dept" class="form-control" name="kode_dept" placeholder="Kode Departement">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="nama_dept" class="form-control" name="nama_dept" placeholder="Nama Departement">
                            </div>
                        </div>
                    </div>
